...
const BURIAL: TaskTemplateItem[] = [
  ...
  { title: 'Schedule graveside or chapel service date/time', defaultDueDays: 2 },
  { title: 'Confirm officiating clergy or celebrant', defaultDueDays: 2 },
  { title: 'Arrange pallbearers (confirm names and contact info)', defaultDueDays: 3 },
  ...
  { title: 'Coordinate reception / gathering (if applicable)', defaultDueDays: 4 },
...
const CREMATION: TaskTemplateItem[] = [
  ...
  { title: 'Obtain signed cremation authorization form (REQUIRED — separate from service contract)', defaultDueDays: 1 },
  { title: 'Schedule cremation with crematory', defaultDueDays: 2 },
  { title: 'Urn selection with family', defaultDueDays: 2 },
  { title: 'Confirm disposition of cremated remains (burial, scattering, kept by family)', defaultDueDays: 3 },
  { title: 'Schedule memorial or celebration of life service (if applicable)', defaultDueDays: 3 },
  { title: 'Confirm officiating clergy or celebrant (if service)', defaultDueDays: 3 },
...
const GRAVESIDE: TaskTemplateItem[] = [
  ...
  { title: 'Embalming / body preparation', defaultDueDays: 1 },
  { title: 'Casket selection with family', defaultDueDays: 1 },
  { title: 'Confirm cemetery plot and grave opening date/time', defaultDueDays: 2 },
  { title: 'Confirm officiating clergy or celebrant', defaultDueDays: 2 },
...
const MEMORIAL: TaskTemplateItem[] = [
  ...
  { title: 'Confirm officiating clergy, celebrant, or family speaker', defaultDueDays: 3 },
  { title: 'Arrange audio/visual for photo tribute (collect photos from family)', defaultDueDays: 3 },
  ...
  { title: 'Coordinate reception after service (if applicable)', defaultDueDays: 4 },
  { title: 'Generate invoice and obtain signed payment agreement', defaultDueDays: 1 },
];
...
export class TaskTemplatesService {
  ...
  ): Array<{ tenantId: string; caseId: string; title: string; dueDate: Date | null }> {
    return this.getTemplate(serviceType).map((t) => ({
      ...
      dueDate:
        t.defaultDueDays === null
          ? null
          : new Date(baseDate.getTime() + t.defaultDueDays * 24 * 60 * 60 * 1000),
    }));
  }
}
