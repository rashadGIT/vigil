...
export class FoundationStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    this.hostedZone = route53.HostedZone.fromLookup(this, 'VigilHostedZone', {
      domainName: 'automagicly.ai',
    });

    this.certificate = new acm.Certificate(this, 'VigilWildcardCert', {
      domainName: 'vigil.automagicly.ai',
      subjectAlternativeNames: ['*.vigil.automagicly.ai'],
      validation: acm.CertificateValidation.fromDns(this.hostedZone),
    });

    const sesIdentity = new ses.EmailIdentity(this, 'VigilSesIdentity', {
